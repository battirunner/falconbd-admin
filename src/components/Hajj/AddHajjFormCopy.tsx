                  ...
                  <div>
                    ...
                    >
                      ...
                      <Form.Item
                        ...
                        name="tour_type_id"
                        rules={[
                          { required: true, message: 'Tour Type Required!' },
                        ]}
                      >
                        <Select
                          showSearch
                          ...
                          <>
                            {fields.map((field, index) => (
                              <div key={field.key} className="flex">
                                ...
                                <Form.Item
                                  name={[field.name, `plan_description`]}
                                  label={`Plan Description ${index + 1}`}
                                  rules={[
                                    {
                                      required: true,
                                      whitespace: true,
                                      message: 'Plan Description Required.',
                                    },
                                  ]}
                                >
                        ...
                        rules={[
                          {
                            validator: async (_, not_included) => {
                              if (!not_included || not_included.length < 1) {
                                return Promise.reject(
                                  new Error(
                        ...
                        rules={[
                          {
                            validator: async (_, other_details) => {
                              if (!other_details || other_details.length < 1) {
                                return Promise.reject(
                                  new Error(
