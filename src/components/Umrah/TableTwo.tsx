  ...
  const fetchData = async (page: number, limit: number) => {
    ...
    try {
      const res = await axios.get(
        ...
        }/tours?tourType=Umrah&page=${page}&limit=${limit}`,
      );
      setLoading(false);
    ...
    <>
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        {loading ? (
          ...
          <>
            <div className="grid grid-cols-8 text-center border-t border-stroke py-4.5 px-4 dark:border-strokedark sm:grid-cols-8 md:px-6 2xl:px-7.5 bg-slate-300">
            ...
            {data.map((tourPackage) => (
              <div
                className="grid grid-cols-8 border-t border-stroke py-4.5 px-4 dark:border-strokedark sm:grid-cols-8 md:px-6 2xl:px-7.5 text-center"
                key={tourPackage.id}
              >
                <div className="col-span-1 items-center">
              ...
              <div className="col-span-1 flex items-center">
                ...
                <div className="col-span-1 items-center">
                  <p className="text-md">{tourPackage.start_datetime}</p>
                  <p className="text-md">{tourPackage.end_datetime}</p>
                </div>
                {/* <div className="col-span-1 items-center">
