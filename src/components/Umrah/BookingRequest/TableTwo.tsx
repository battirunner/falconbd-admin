  ...
  const fetchData = async (page: number, limit: number) => {
    ...
    try {
      const res = await axios.get(
        ...
        }/booking?booking_item_type=UMRAH&page=${page}&limit=${limit}`,
        {
          headers: {
            //@ts-ignore
        ...
        {loading ? (
          ...
          <>
            ...
            {data.map((bookingItem) => (
              ...
              >
                <div className="col-span-2 flex items-center text-md">
                ...
                <div className="col-span-1 items-center mt-4  text-center">
                  <p className="text-sm text-black dark:text-white">
                    {/* {bookingItem.payment_status} */}
                    <Status statusType={bookingItem.payment_status} />
                  </p>
                  <p className="text-md text-meta-3 mt-4">
                    ৳{bookingItem.price}
                  </p>
                </div>
